...
export const ICONS = {
  ...
  terminal: <><rect x="3" y="5" width="18" height="14" rx="1.5" /><polyline points="7 10 10 12 7 14" /><line x1="12" y1="15" x2="17" y2="15" /></>,
  filePlus: <><path d="M14 3H6a1 1 0 0 0-1 1v16a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V8l-5-5z" /><polyline points="14 3 14 8 19 8" /><line x1="12" y1="12" x2="12" y2="18" /><line x1="9" y1="15" x2="15" y2="15" /></>,
  diff: <><line x1="6" y1="3" x2="6" y2="13" /><polyline points="3 10 6 13 9 10" /><line x1="6" y1="13" x2="6" y2="21" /><line x1="18" y1="21" x2="18" y2="11" /><polyline points="15 14 18 11 21 14" /><line x1="18" y1="11" x2="18" y2="3" /></>,
  notebook: <><rect x="4" y="3" width="14" height="18" rx="1.5" /><line x1="8" y1="3" x2="8" y2="21" /><line x1="10" y1="8" x2="15" y2="8" /><line x1="10" y1="12" x2="15" y2="12" /></>,
  agentSpawn: <><circle cx="8" cy="10" r="2.5" /><path d="M3 19c1-2.5 2.7-4 5-4s4 1.5 5 4" /><circle cx="17" cy="6" r="2" /><line x1="17" y1="10" x2="17" y2="14" /><polyline points="14.5 12 17 14 19.5 12" /></>,
  scroll: <><path d="M4 5a2 2 0 0 1 2-2h11l3 3v13a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5z" /><line x1="8" y1="9" x2="16" y2="9" /><line x1="8" y1="13" x2="16" y2="13" /><line x1="8" y1="17" x2="13" y2="17" /></>,
  task: <><polyline points="4 12 8 16 20 4" /><path d="M4 6h8M4 18h8" /></>,
  checkSquare: <><rect x="4" y="4" width="16" height="16" rx="2" /><polyline points="8 12 11 15 16 9" /></>,
  emptySquare: <rect x="4" y="4" width="16" height="16" rx="2" />,
  halfSquare: <><rect x="4" y="4" width="16" height="16" rx="2" /><circle cx="12" cy="12" r="3" fill="currentColor" /></>,
  link2: <><path d="M9 15l6-6" /><path d="M10 7l1-1a4 4 0 0 1 5.7 5.7L15 13" /><path d="M14 17l-1 1a4 4 0 0 1-5.7-5.7L9 11" /></>,
  power: <><path d="M7.5 5A8 8 0 1 0 16.5 5" /><line x1="12" y1="3" x2="12" y2="12" /></>,
