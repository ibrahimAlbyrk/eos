...
export function useUi() {
  ...
  const { openPanelIn, openNewTabIn, setTabIn, closeTabIn, closePanelIn, toggleSidePanelIn, toggleFullscreenIn, setWidthIn, openFileIn, closeFileIn, panelsByPane } = selection;
  ...
  return useMemo(() => ({
    ...
    openPanel, openNewTab, setTab, closeTab, closePanel, toggleSidePanel, toggleFullscreen, setSidePanelWidth, openFile, closeFile,
  }), [
    navigation, selection, pane, composer, attention, search, settings, scopePane,
    openPopoverIn, openPop, closeAllPops,
    panelState, openPanel, openNewTab, setTab, closeTab, closePanel, toggleSidePanel, toggleFullscreen, setSidePanelWidth, openFile, closeFile,
  ]);
}
