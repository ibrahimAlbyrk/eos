...
// The viewer inside keeps its own island surface (.file-viewer et al) + shared
// close button (PanelCloseButton). Extracted so the dock's per-panel positioning is
// one component and adding a panel type never touches it (open/closed).
